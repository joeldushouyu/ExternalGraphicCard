...
Configure the setting for **FlagB** to be Partial Flag with watermark dedicate to thread0.
...
Configure the setting for **FlagD** to be Partial Flag with watermark dedicate to thread3.
